                    ...
                    <b-tab title="Start" active>
                        <form>
                            <div class="form-group">
                                <label for="travelLength">Witamy w kreatorze pakowania przedmiotów w Szafiarni. Wprowadź
                                    liczbę dni zaplanowanego wyjazdu:</label>
                                <input type="number" class="form-control" id="travelLength" aria-describedby="emailHelp"
